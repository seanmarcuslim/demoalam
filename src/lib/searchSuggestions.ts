...
export const SEARCH_SUGGESTION_GROUPS: SearchSuggestionGroup[] = [
  {
    ...
    subtitle_fil: 'Resume, interview, mga kailangan sa trabaho, payroll, at unang sahod.',
    colorKey: 'success' as const,
    items: ['first job', 'resume', 'interview', 'job requirements', 'kulang sahod'],
  },
  {
    title_en: 'Money safety',
    title_fil: 'Proteksyon sa pera',
    subtitle_en: 'Emergency fund, lost cards, wrong sends, and loan app pressure.',
    subtitle_fil: 'Emergency fund, nawalang card, maling padala, at pangungulit ng loan app.',
  ...
  },
  {
    ...
    subtitle_fil: 'Kapag pera, account, personal na impormasyon, o reklamo ang problema.',
  ...
  },
  {
    ...
    subtitle_fil: 'Loan app, pekeng recruiter, scam sa e-wallet, at phishing.',
    colorKey: 'danger' as const,
  ...
  },
  {
    ...
    subtitle_fil: 'Hanapin ang tulong sa pag-aaral, cash-for-work, at kabuhayan.',
    colorKey: 'accent' as const,
