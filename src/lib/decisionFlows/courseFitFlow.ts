...
export const courseFitFlow = {
  ...
  regret_title_en: 'Students who regret their course later often say:',
  regret_title_fil: 'Madalas sabihin ng nagsisisi sa course nila:',
  regret_items_en: [
    'I did not know what the job was really like.',
    'I chose based on salary only.',
    'I followed friends instead of fit.',
    'I underestimated the total cost.',
    'I had no backup option.',
  ],
  regret_items_fil: [
    'Hindi ko alam kung ano talaga ang trabaho.',
    'Salary lang ang naging basehan ko.',
    'Sumunod ako sa friends, hindi sa fit.',
    'Minaliit ko ang total na gastos.',
    'Wala akong backup option.',
  ],
  before_title_en: 'Before deciding:',
  before_title_fil: 'Bago magdesisyon:',
  before_items_en: [
    'Compare 3 course options.',
    'Talk to one graduate or professional.',
    'Estimate the total cost.',
    'Check entry-level job realities.',
  ],
  before_items_fil: [
    'Ikumpara ang 3 course option.',
    'Makipag-usap sa isang graduate o professional.',
    'Tantiyahin ang total na gastos.',
    'I-check ang realidad ng entry-level job.',
  ],
