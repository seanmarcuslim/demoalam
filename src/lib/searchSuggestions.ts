...
export const SEARCH_SUGGESTION_GROUPS: SearchSuggestionGroup[] = [
  {
    ...
    subtitle_fil: 'Resume, interview, requirements, payroll, at unang sahod.',
  ...
  },
  {
    ...
    subtitle_fil: 'Emergency fund, nawalang card, maling padala, at loan app pressure.',
  ...
  },
  {
    ...
    subtitle_fil: 'Hanapin ang student aid, cash-for-work, at kabuhayan.',
    colorKey: 'accent' as const,
